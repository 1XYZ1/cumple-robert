...
export default function MessengerStepsModal({ onClose }) {
...
${window.location.href}`;
  ...
  const steps = [
    ...
    },
    {
      ...
      description: "Abre Messenger y comparte como prefieras",
      icon: "fab fa-facebook-messenger",
      action: {
        text: "Abrir Messenger",
        ...
        >
          ...
          <div class="mt-4 text-center">
            ...
            <p class="text-gray-600 dark:text-gray-400">
              {currentStep() === 2 ?
                ...
                "Comparte la invitación en Messenger"}
            </p>
          </div>
          ...
          <div class="mt-8">
            <div class="flex items-center justify-center mb-6">
              <div class={`w-16 h-16 rounded-full bg-gradient-to-r from-blue-400 to-blue-600
            ...
            <button
              ...
              class={`w-full bg-gradient-to-r from-blue-400 to-blue-600
                hover:from-blue-500 hover:to-blue-700 text-white p-4
              ...
              {steps.map((_, index) => (
                <div
                  class={`w-2 h-2 rounded-full transition-all duration-300 ${
                    index === currentStep()
                      ? 'bg-gradient-to-r from-blue-400 to-blue-600 w-4'
                      : index < currentStep()
                      ? 'bg-blue-600'
                      : 'bg-gray-300'
                  }`}
